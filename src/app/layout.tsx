...
export const metadata: Metadata = {
  title: {
    default: `${SITE_NAME} — каталог крипто-сервисов, гайды и чекер дропов`,
    template: `%s — ${SITE_NAME}`,
  },
  description:
    "AllTools — каталог крипто-сервисов: биржи, кошельки, DeFi, AI, NFT и инфраструктура. Тир-лист, сравнение, гайды и чекер дропов. Без рефералок и партнёрских подборок.",
  icons: {
    icon: "/favicon.svg",
  },
};
