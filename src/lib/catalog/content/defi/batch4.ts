...
export const DEFI_BATCH_4: Record<string, PlatformContent> = {
  ...
  "router-bridge": {
    short:
      "Мост Router Nitro — кроссчейн-переводы через инфраструктуру Router Protocol.",
    long:
      "Router Bridge (Nitro) переводит активы между сетями через кроссчейн-сеть Router. Для пользователей, уже в экосистеме Router, — естественное расширение swap + bridge.",
    tagline: "Мостовой слой Router Protocol — mesh, а не один hop.",
    highlight:
      "Router Protocol построил сеть кроссчейн-ликвидности; мост Nitro — интерфейс для переводов активов между поддерживаемыми L1/L2. Модель комиссий и маршрут через intent framework Router. Меньше узнаваемости бренда, чем у Stargate или Across, но интеграция с DEX/агрегатором Router даёт единый стек одного вендора. Стандартные риски моста: смарт-контракты, набор валидаторов Router и ликвидность на целевой сети.",
    facts: [
      "Router ребрендился и расширял Nitro после первого кроссчейн-бума — мост стал связующим звеном между swap и lending-модулями Router.",
      "Фермеры сообщества гоняли мелкие переводы для testnet/mainnet-квестов — типичный паттерн для всплесков TVL мостов среднего уровня.",
      "Комиссии Router Nitro конкурировали с мостами LayerZero на некоторых маршрутах — но глубина ликвидности всё ещё зависит от маршрута.",
    ],
    tips: [
      "Крупные переводы делайте частями — ликвидность моста на экзотических парах может быть тонкой.",
    ],
    warnings: [
      "Проверяйте адреса контрактов на официальном app.routernitro.com — поддельные UI мостов крадут approve.",
    ],
  },
  rubic: {
    short:
